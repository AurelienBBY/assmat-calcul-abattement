...
## Lot 6 — Distribution & vraie sauvegarde — étapes 1-2/3 ✅ le 2026-07-19
...
**Reste (étape 3)** : auto-sauvegarde File System Access API (PC) + indicateur « Fichier à jour ✓ » + écran de restauration à vide + boutons guidés iPhone (« Reprendre la sauvegarde » / « Envoyer ma saisie » via partage iOS).
